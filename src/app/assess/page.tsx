      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 pt-16 pb-16">
        ...
        <div className="grid gap-4">
          {Object.values(calculators).map((calc) => (
            ...
            >
              <h2 className="text-sm lg:text-base font-bold text-gray-900 dark:text-white mb-1">{calc.name}</h2>
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-2">{calc.tagline}</p>
